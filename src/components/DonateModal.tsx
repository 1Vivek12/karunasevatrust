...
import { X, Heart, ShieldCheck, QrCode, CreditCard, Building2, CheckCircle2, Download, Copy, Sparkles, AlertCircle } from 'lucide-react';
...
export const DonateModal: React.FC<DonateModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-3xl shadow-2xl border border-emerald-100 w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200 my-8">
        ...
        {!isSuccess ? (
          <form onSubmit={handleSubmitDonation} className="p-5 sm:p-7 space-y-6 max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-3 pt-2 border-t border-slate-100">
              ...
              {/* Dynamic Payment QR / Bank Details preview */}
              {formData.paymentMethod === 'upi' && (
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-4">
              <div className="text-xs text-slate-500">
                सुरक्षित एवं 80G प्रमाणित पोर्टल
              </div>
              ...
              >
                {isProcessing ? (
                  <>
                    ...
                    <span>भुगतान संसाधित हो रहा है...</span>
                  </>
                ) : (
                  <>
