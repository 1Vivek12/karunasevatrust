...
export const TRUST_INFO = {
  ...
  panNo: "AAATK8492K",
  taxExemption: "पंजीकृत जनकल्याणकारी न्यास (Govt. Registered Trust)",
  phone: "+91 7905357033, +91 8840193573",
  email: "info@karunasevatrust.com",
  address: "हरसेवकपुर नंबर- 2, निकट अंबा चरण चौराहा, गोरखपुर",
  workingHours: "सोमवार - शनिवार: सुबह 10:00 बजे से शाम 6:00 बजे तक"
};
...
export const RECENT_DONORS: RecentDonor[] = [
  { id: 'd1', name: 'श्री रमेश चंद शर्मा', amount: 5100, cause: 'वृक्षारोपण', city: 'गोरखपुर', date: 'आज' },
  { id: 'd2', name: 'श्रीमती सुनीता गर्ग', amount: 1100, cause: 'भोजन सेवा', city: 'जयपुर', date: 'आज' },
  { id: 'd3', name: 'श्री विकास गुप्ता', amount: 501, cause: 'वस्त्र वितरण', city: 'नोएडा', date: 'कल' },
  { id: 'd4', name: 'डॉ. संजय मेहरा', amount: 5100, cause: 'स्वास्थ्य सहायता', city: 'गुरुग्राम', date: 'कल' },
  { id: 'd5', name: 'श्रीमती पुष्पा देवी', amount: 101, cause: 'विवाह सहयोग', city: 'गाजियाबाद', date: '2 दिन पहले' }
];
